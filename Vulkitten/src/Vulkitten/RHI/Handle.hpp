...
// (ABA) protection.
//
// - Id == 0 means Null (uninitialized) Handle.
// - Generation is bumped on each slot reuse to invalidate stale handles.
// - Tag prevents implicit conversion between handle types at compile time.
// ============================================================
...
public:
    ...
    // For use as key in std::unordered_map
    struct Hash
    {
