...
### ✅ Phase: 引擎资产管理 (Shader + Resource)

### ✅ Task 1 已完成 (2026-06-20) — 引擎 Shader 资产迁移

- 创建 `Vulkitten/assets/shaders/` 和 `Vulkitten/assets/computeshaders/common/`
- 所有引擎 Pass 使用的 shader（FlatColor、SolidColor、Texture、TextureEntity、Particle）和 compute shader（ParticleSimArg、ParticleSim、ParticleEmit、ParticleRenderArg）已从 Sandbox/assets/ 移入 Vulkitten/assets/
- Sandbox/assets/ 现在仅保留 textures/
